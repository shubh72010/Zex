const { PermissionFlagsBits } = require('discord.js'); const warnedUsers = new Map(); const snipedMessages = new Map(); const afkUsers = new Map();
...
} catch (err) { console.error(❌ Error in command '${commandName}':, err); return interaction.reply({ content: '❌ There was an error executing this command.', ephemeral: true }); } };
